...
public class DFSStripedInputStream extends DFSInputStream {
  ...
  private List<ExtendedBlock> badBlocks;
  ...
  public DFSStripedInputStream(DFSClient dfsClient, String src, boolean verifyChecksum, ErasureCodingPolicy ecPolicy, LocatedBlocks locatedBlocks,
      List<ExtendedBlock> badBlocks) throws IOException {
    this(dfsClient, src, verifyChecksum, ecPolicy, locatedBlocks);
  ...
  List<ExtendedBlock> getBadBlocks(){
    return badBlocks;
  }
