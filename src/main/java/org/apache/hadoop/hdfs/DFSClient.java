...
public class DFSClient implements java.io.Closeable, RemotePeerFactory,
  ...
  public DFSInputStream open(String src, List<ExtendedBlock> badblocks) throws IOException {
    return open(src, dfsClientConf.getIoBufferSize(), true, badblocks);
  }
  ...
  public DFSInputStream open(String src, int buffersize, boolean verifyChecksum,
      FileSystem.Statistics stats, List<ExtendedBlock> badblocks) throws IOException {
    return open(src, buffersize, verifyChecksum, badblocks);
  }
  ...
  public DFSInputStream open(String src, int buffersize, boolean verifyChecksum, List<ExtendedBlock> badblocks)
      throws IOException {
    checkOpen();
    //    Get block info from namenode
    try (TraceScope ignored = newPathTraceScope("newDFSInputStream", src)) {
